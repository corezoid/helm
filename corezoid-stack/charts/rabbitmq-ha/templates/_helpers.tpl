...
{{- define "rabbitmq-ha.definitions" -}}
{
 ...
 {{ .Values.definitions.globalParameters | indent 4 }}
  ...
  "users": [
    {
      "name": {{ .Values.rabbitmq.secret.data.username | quote }},
      "password": {{ .Values.rabbitmq.secret.data.password | quote }},
      "tags": "administrator"
    },
    {
...
{{- end }}
  ...
  "vhosts": [
    { "name": {{ .Values.rabbitmq.secret.data.vhost | quote }} },
    { "name":  "/gitcall" },
    { "name": "/dundergitcall" },
    {
...
{{- end }}
  ...
  "permissions": [
    {
      "user": {{ .Values.rabbitmq.secret.data.username | quote }},
      "vhost": {{ .Values.rabbitmq.secret.data.vhost | quote }},
      "configure": ".*",
      "read": ".*",
      "write": ".*"
    },
