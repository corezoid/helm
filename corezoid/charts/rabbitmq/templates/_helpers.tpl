...
{{ .Values.volumePermissions.image.registry }}/{{ .Values.volumePermissions.image.registry.repository }}:{{ .Values.volumePermissions.image.registry.tag }}
{{- end -}}
...
{{- define "rabbitmq.password" -}}
    {{- if not (empty .Values.global.mq.secret.data.password) -}}
